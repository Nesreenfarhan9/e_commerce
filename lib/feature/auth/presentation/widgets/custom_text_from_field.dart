...
class CustomTextFormField extends StatelessWidget {
  CustomTextFormField(
    {this.controller,
     ...
     this.obscureText=false, this.onToggleVisibility,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: isPassword ? IconButton(
          ...
          icon: Icon( obscureText? Icons.visibility_off: Icons.visibility,color: AppColors.gray400,),  onPressed: onToggleVisibility, ):null,
